...
class Grid2D(Grid):
    ...
    def __init__(self, time_seq, lat_seq, lon_seq, silence_level=0):
        """
        Initialize an instance of Grid2D.
    ...
    def __str__(self):
        """
        Return a string representation of the Grid2D object.
        """
    ...
    def save_txt(self, filename):
        """
        Save the Grid2D object to text files.
    ...
    def LoadTXT(filename):
        ...
        :arg str filename: The name of the files where the Grid2D object is
            stored (excluding endings).
        :rtype: Grid object
        :return: :class:`Grid2D` instance.
        """
        try:
